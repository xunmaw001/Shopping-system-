...
import center from '@/views/center'
    import discussgouwuzixun from '@/views/modules/discussgouwuzixun/list'
    import gouwuzixun from '@/views/modules/gouwuzixun/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/discussgouwuzixun',
        name: '购物资讯评论',
        component: discussgouwuzixun
      }
      ,{
	path: '/gouwuzixun',
        name: '购物资讯',
        component: gouwuzixun
      }
      ,{
	path: '/yonghu',
        name: '用户',
